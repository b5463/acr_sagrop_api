...
class Application {
  ...
  _printStartupInfo() {
    ...
    const apiPort = process.env.API_PORT || 'unknown';
    const apiUrl = process.env.API_ENDPOINT || `http://localhost:${apiPort}`;
    ...
    console.log('   ➜  \x1b[37m%s\x1b[0m', `API URL:  \x1b[32m\x1b[1m${apiUrl}:${apiPort}${apiPath}\x1b[0m`);
    console.log('   ➜  \x1b[37m%s\x1b[0m', `API PORT: \x1b[32m\x1b[1m${apiPort}\x1b[0m`);
