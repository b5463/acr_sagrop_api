...
class ConfigController {
	...
	loadConfig() {
		try {
			const { APP_NAME, API_VERSION, API_ENDPOINT, API_PORT, MAX_UPLOAD_SIZE } = process.env
			...
			const apiUrl = this._generateApiUrl(API_ENDPOINT, API_PORT, API_VERSION.split(".")[0])
